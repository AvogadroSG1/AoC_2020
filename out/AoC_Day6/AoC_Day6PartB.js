...
lzdaftrjphco`;
    ...
    groups.forEach((group, _i, _arr) => {
        ...
        individualResponses.forEach((response, _v, _arr) => {
            intersection = intersection.filter((_value, _i, _arr) => response.split("").includes(_value));
        });
        total += intersection.length;
        groupValues.push(intersection.length);
    });
...
//# sourceMappingURL=AoC_Day6PartB.js.map