{
    let rawNewPasswords = `3-4 t: dttt
5-7 l: llmlqmblllh
...
14-16 p: tpkppppppppppppppppp`;
    let splitNewRow = function (s, i, arr) {
        let toReturn = {};
        let x = s.split(/[\s-:]+/);
    ...
    let validNewPassword = function (toCheck) {
    ...
    let totalNewValid = rawNewPasswords
        .split("\n")
        .map(splitNewRow)
        .filter(validNewPassword);
    console.log(totalNewValid.length);
}
//# sourceMappingURL=AoC_Day2PartB.js.map